...
const Testimonials = () => {
  ...
  return (
    <div className="flex  flex-col px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30 bg-slate-50">
      <Title
        title="What Our Guests Stay"
        subTitle=" Hear what our users say about us. We're always looking for ways to
